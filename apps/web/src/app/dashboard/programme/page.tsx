...
const StatCell = ({ label, value, loading }: StatCellProps): ReactElement => (
...
export default function ClientProgrammePage(): ReactElement {
  ...
  const overviewQuery = useQuery({
    queryKey: ["client", "nestle", "overview", filterParams],
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-6 pb-10">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex shrink-0 flex-wrap items-center justify-end gap-2">
          ...
          <button
            ...
            onClick={() => void queryClient.invalidateQueries({ queryKey: ["client", "nestle"] })}
          >
            Refresh
          </button>
        </div>
      ...
      <section className={`${shellCard} p-4`}>
        ...
        <ul className="mt-3 flex flex-wrap gap-3 text-sm">
          <li>
            <Link href="/dashboard/vendors" className={calmMutedLinkClass}>
              Vendors
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link href="/dashboard/attendance" className={calmMutedLinkClass}>
              Attendance
            </Link>
          </li>
        </ul>
