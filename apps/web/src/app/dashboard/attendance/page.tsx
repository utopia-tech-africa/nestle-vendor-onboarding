...
export default function ClientAttendancePage(): ReactElement {
  ...
  return (
    <AttendanceDailyDashboard
      ...
      description="Read-only roll-up of promoter check-in and check-out for the Nestlé programme. Working hours follow the same timezone rules as Operations."
      date={date}
