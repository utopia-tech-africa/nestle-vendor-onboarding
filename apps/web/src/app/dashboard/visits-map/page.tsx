...
export default function ClientVisitsMapPage(): ReactElement {
  ...
  const visitsQuery = useQuery({
    queryKey: ["client", "visits-map", filterParams],
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-6 pb-10">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Read-only map of vendor visits. Incomplete visits are labeled on the marker popup.
        </p>
      </div>
